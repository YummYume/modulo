...
export default function ScopeChoice() {
    ...
    return (
        <Box className="w-100 container-fluid my-2">
            <Box className="flex-column row justify-content-around h-100">
                <Box className="col-12 text-center" sx={{ color: theme.palette.primary.main }}>
                ...
                <Box className="col-12">
                    <Box className="row justify-content-around">
                        {user.scopes.map((scope) => (
                            <Box className="col-xl-2 col-lg-4 col-md-5 col-sm-6 col-12 my-3" key={scope.id}>
                                <motion.div
